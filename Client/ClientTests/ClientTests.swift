...
class ClientTests: XCTestCase {
    ...
    func testMatchingWithPredicate() async throws {
        ...
        try await app.staticTexts().element(matching: "label == \"SomethingViewAccessbilityLabel\"").assertElementExists()
    }
    ...
    func testMatchingWithPredicateAsync() {
        ...
        let somethingView = app.staticTexts.element(matching: "label == \"SomethingViewAccessbilityLabel\"")
