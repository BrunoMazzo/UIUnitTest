...
public struct AccessibilityAuditIssue: Sendable {
    ...
    public init(data: AccessibilityAuditIssueData) {
        ...
        self.compactDescription = data.compactDescription
        self.detailedDescription = data.detailedDescription
        self.auditType = AccessibilityAuditType(rawValue: data.auditType)
    }
}
