...
class UIServer {
    ...
    private func registerApplicationRoutes() async {
    ...
    private func registerElementQueryRoutes() async {
    ...
    private func registerInteractionRoutes() async {
    ...
    private func registerElementStateRoutes() async {
    ...
    private func registerElementInfoRoutes() async {
    ...
    private func registerElementCollectionRoutes() async {
    ...
    private func registerCoordinateRoutes() async {
    ...
    private func registerAccessibilityRoutes() async {
    ...
    private func registerUtilityRoutes() async {
